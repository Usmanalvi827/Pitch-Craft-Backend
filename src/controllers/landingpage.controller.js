import { landingPageReportGenerateByAi } from "../ai/services/landingpage.service.js";
import StartUpProject, { calculateProjectStatus } from "../models/startup.models.js";

export async function generateLandingPage (req, res) {
     try {
        ...
        const landingPageReport = await landingPageReportGenerateByAi({
          title: project.title,
          idea: project.idea,
        ...
        project.landingPage = landingPageReport;
